export default {
  ...
  'repository.malianghang.desc': '基于 Angular 1 框架开发的一套官方电商网站和后台系统，使用 RequiresJS 完成 AMD 模式开发。移动端使用 ionic，桌面端使用 Bootstrap / material。后端主要使用 LeanCloud 第三方云服务平台;<br/><br/>主要负责前端开发工作，编写页面及交互效果，参与部分接口开发。<br/><br/>学习到模块化开发、前端自动化开发，能够完成前端组件编写或改写的需求。完成复杂布局，确保产品兼容性。也由于创业公司在设计和产品上的空缺，在开发过程中同时兼顾对产品的思考。力求在项目中追求更优雅的代码、更高的性能效率。',
  'repository.dianwoda.desc': '前端项目使用 React + Redux + AntD 搭建，后端采用 dubbo 微服务架构，通过 Node.js 网关层提供接口。<br/><br/>参与新需求的评审、开发及对已有功能的维护工作，开发前端页面及网关部分，主要负责骑手及在线商城模块，并参与异地多活的改造。<br/><br/>后端微服务化及 Node.js 网关层的介入使前后端开发工作更易协作，提高前端对于接口数据的可控性。',
};
